...
<p align='center'>
<input type="button" onclick="seq('i,from,base,flossely;i,from,basic,flossely;i,from,pub,flossely;i,from,nixfonts,flossely;i,from,msfonts,flossely;i,from,hsis,flossely;');" value="Base Package">
</p>
</body>
</html>
